...
| [cloud_firestore](https://pub.dev/packages/cloud_firestore)               | 4.8.3   | A Flutter plugin to use the Cloud Firestore API, a cloud-hosted, NoSQL database with live synchronization and offline support on Android and iOS.                  |
| [equatable](https://pub.dev/packages/equatable)                           | 2.0.5   | Simplify Equality Comparisons.                                                                                                                                     |
| [firebase_auth](https://pub.dev/packages/firebase_auth)                   | 4.7.1   | Flutter plugin for Firebase Auth, enabling Android and iOS authentication using passwords, phone numbers and identity providers like Google, Facebook and Twitter. |
...
| [flutter](https://flutter.dev/)                                           | 3.10.5  | Flutter SDK.                                                                                                                                                       |
...
| [pinput](https://pub.dev/packages/pinput)                                 | 2.2.31  | A flutter package for custom beautiful pin code fields.                                                                                                            |
