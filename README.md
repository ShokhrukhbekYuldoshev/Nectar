...
| [google_sign_in](https://pub.dev/packages/google_sign_in)                 | 6.1.6   | Flutter plugin for Google Sign-In, a secure authentication system for signing in with a Google account on Android and iOS.                                         |
